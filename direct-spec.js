// Script to directly create a properly structured spec file
import * as fs from 'fs';

const spec = {
  endpoint: 'carrot/core/improvements',
  summary: 'Enhance Carrot to support multi-task specs, task metadata, a refine_spec tool, user notifications, and documentation.',
...
fs.writeFileSync('carrot-spec.json', JSON.stringify(spec, null, 2));
